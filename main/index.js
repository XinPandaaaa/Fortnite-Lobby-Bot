...
(async () => {
  ...
  try {
    ...
    Options.auth.authorizationCode = async () => Client.consoleQuestion('[XinPanda] [FORTNITE] Please enter an authorization code: ');
  }
  ...
  console.log('\x1b[36m', '╔══════════════════════ [ XinPanda Lobby Bot ] ═══════════════════════════╗' ,'\x1b[0m')
  console.log('\x1b[36m', '╚════════════════════[ Support: https://dsc.gg/xinpanda ]═════════════════╝' ,'\x1b[0m')
  console.log('► Visit my website: https://xinpanda.wixsite.com/pweb')
  console.log('\x1b[36m', '▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬▬' ,'\x1b[0m')    

  if (process.env['TOKEN'] === 'TOKEN') return console.log('[XinPanda] [DISCORD]', 'Please enter a valid token in Secrets(.env) or config.js');
  ...
  bot.on('party:member:joined', member => {
    ...
    console.log('[XinPanda] [FORTNITE]', `${member.displayName} has joined the party. New member count: ${bot.party.members.size}.`);
  ...
  bot.on('party:invite', invite => {
    console.log('[XinPanda] [FORTNITE]', `Received a party invite from ${invite.sender.displayName}.`);
    ...
    console.log('[XinPanda] [FORTNITE]', `Invite from ${invite.sender.displayName} has been ${config.fortnite.acceptInvite ? 'accepted' : 'declined'}.`);
  });

  bot.on('friend:request', request => {
    console.log('[XinPanda] [FORTNITE]', `Received a friend request from ${request.displayName}.`);
    ...
    console.log('[XinPanda] [FORTNITE]', `Friend request from ${request.displayName} has been ${config.fortnite.acceptFriend ? 'accepted' : 'declined'}.`);
  });
  ...
  client.on('ready', () => {
    client.user.setActivity("Dev. XinPanda Bots")
    ...
    console.log('[XinPanda] [DISCORD]', `Client ready as ${client.user.tag} [${client.commands.size} commands]`);
    console.log('[XinPanda] [FORTNITE]', `Client ready as ${bot.user.displayName}.`);
  });
})();
